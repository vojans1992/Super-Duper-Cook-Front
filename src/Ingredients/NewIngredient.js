            ...
            <Box
                ...
                <FormControl sx={{ width: "100%" }} error={allergenError}>
                    ...
                    <Stack direction='column'>
                        ...
                        {/* //ovo ce biti cip selektovanih autora 
   idemo kroz niz autora p[rosledim a, kreiramo chip, cip prikazuje podatke tako sto koristi
   label a, tj podatak koji smo uneli. Cip ima i x za brisanje podataka,-onDelete
    definisemo dogadjaj. Da bismo znali na koji smo cip kliknuli moramo da uradimo sledece
    moramo da zapamtimo index tog cipa-ii. Posto je to lista, selektovani autori filtirani na nacin 
    tako da je v vrednost koji je autor a "i" je indeks tog autora, onda kazemo uzmi sve autore
    koji se ne nalaze na vrednosti ii, onda ostavlja sve koji su razliciti od ovog kojeg brisemo */ }
                        <Stack direction='row'>
                            {
